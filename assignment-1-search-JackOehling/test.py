...
If your methods work correctly, these outputs should always be True, since if no 
better solution is found, the original maze is returned.
'''
print("------------------------------------------------------------------------------------")
...
after_hill_descent = HILLDESCENT(maze,start_state,goal_state,100)[1]
print(energy >= after_hill_descent)
print("after_hill_descent")
print(after_hill_descent)

after_random_restart = HILLDESCENT_RANDOM_RESTART(maze,start_state,goal_state,100,5)[1]
print(energy >= after_random_restart)
print("after_random_restart")
print(after_random_restart)

after_uphill = HILLDESCENT_RANDOM_UPHILL(maze,start_state,goal_state,100,0.03)[1]
print(energy >= after_uphill)
print("after_uphill")
print(after_uphill)

after_annealing = SIMULATED_ANNEALING(maze,start_state,goal_state,100,1000,0.98)[1]
print(energy >= after_annealing)
print("after_annealing")
print(after_annealing)
